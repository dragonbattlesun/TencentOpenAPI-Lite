#
#  Be sure to run `pod spec lint TencentOpenAPI-Lite.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.1"
  spec.summary      = "A short description of TencentOpenAPI-Lite."
  ...
  # spec.resource  = "icon.png"
   spec.resources = "TencentOpenAPI/TencentOpenApi_IOS_Bundle.bundle"
